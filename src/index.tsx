...
ReactDOM.render(<Minutes />, domElement);

// ReactDOM.render(
//     <div>
//         {/*<NewPostForm onSuccess={{post => {console.log(post)}}}/>*/}
//         <CTAButton
//             onKeyboardPress={() => {
...
// const elementImg = (
//     <img src={user.avatarUrl || '../public/logo192.png'} />
// );
//
